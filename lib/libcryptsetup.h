 ...
 * @returns @e 0 on success or negative errno value otherwise.
 *
 * @note The metadata area is stored twioce and both copis contain 4k binary header.
 * Only 16,32,64,128,256,512,1024,2048 and 4096 kB value is allowed (see LUKS2 specification).
 * @note Keyslots area must be multiple of 4k with minimum 64k and maximum 128MB.
 */
